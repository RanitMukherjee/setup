...
# ===============================
# Installs: Go, VS Code, Docker, GitHub CLI, Git config
...
# --- 3. Install VS Code (official .deb with repo for updates) ---
...
# --- 4. Install Docker Engine (official) ---
...
echo "You can now develop, sync forks with 'gh repo sync', and use Go, VS Code, Docker, and GitHub CLI."
